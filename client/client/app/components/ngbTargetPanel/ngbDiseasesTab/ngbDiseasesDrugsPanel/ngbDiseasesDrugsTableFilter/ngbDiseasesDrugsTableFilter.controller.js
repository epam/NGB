...
export default class ngbDiseasesDrugsTableFilterController {
    ...
    static get UID() {
        return 'ngbDiseasesDrugsTableFilterController';
    }
    ...
    apply() {
        ...
        if (currValueStr !== prevValueStr) {
            this.ngbDiseasesDrugsPanelService.setFilter(this.column.field, currValue);
            this.dispatcher.emit('target:diseases:drugs:filters:changed');
        }
        if (this.listElements) {
            this.listElements.refreshList(null);
        }
