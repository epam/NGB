...
export default class ngbOrthoParaTableController extends baseController {
    ...
    async initialize() {
        ...
        Object.assign(this.gridOptions, {
            ...
            paginationPageSize: this.ngbOrthoParaTableService.historyPageSize,
    ...
    async loadData() {
        try {
            ...
            } else if (this.ngbOrthoParaTableService.orthoPara.length) {
                this.loadError = null;
                this.gridOptions.data = this.ngbOrthoParaTableService.orthoPara;
                this.isEmptyResults = false;
            } else if (this.ngbOrthoParaTableService.currentPage > 1) {
                this.ngbOrthoParaTableService.changePage(1);
            } else {
