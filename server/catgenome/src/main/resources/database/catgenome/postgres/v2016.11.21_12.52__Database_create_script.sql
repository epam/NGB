...
CREATE SEQUENCE catgenome.S_BED START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_BED_GRAPH START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "biological_data_item" table
CREATE SEQUENCE catgenome.S_BIOLOGICAL_DATA_ITEM START WITH 1 INCREMENT BY 1;

-- sequence for bookmark ids
CREATE SEQUENCE catgenome.S_BOOKMARK START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_BOOKMARK_ITEM START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_BUCKET START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "chromosome" table
CREATE SEQUENCE catgenome.S_CHROMOSOME START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "gene_item" table
CREATE SEQUENCE catgenome.S_GENE_FILE START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE catgenome.S_LIST START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_MAF START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_PERSON START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "project" table
CREATE SEQUENCE catgenome.S_PROJECT START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "project_item" table
CREATE SEQUENCE catgenome.S_PROJECT_ITEM START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_PROTEIN_SEQUENCE START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "reference_genome" table
CREATE SEQUENCE catgenome.S_REFERENCE_GENOME START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_SEG START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_SEG_SAMPLE START WITH 1 INCREMENT BY 1;

-- creates a sequence used to generate primary key values for "vcf" table
CREATE SEQUENCE catgenome.S_VCF_FILE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_VCF_SAMPLE START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE catgenome.S_VG START WITH 1 INCREMENT BY 1;
...
CREATE TABLE IF NOT EXISTS catgenome.mutex(
